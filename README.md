...
- Categorizes the BMI into 4 categories:
...
- **CSS**: For styling and layout to make the calculator visually appealing.
- **JavaScript**: To calculate BMI and update the result dynamically.
